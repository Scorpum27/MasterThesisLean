...
// %%% --- %% --- %% --- %% --- %% --- %% --- %% --- %% --- DISPLAY EVOLUTION OF NETWORKS --- %% --- %% --- %% --- %% --- %% --- %% --- %% --- %% --- %% --- %%%
		...
		final String finalNetwork = args[0];  //"Network4";
		System.out.println(finalNetwork.getClass());
		System.exit(0);
		final Integer firstGeneration = 1;
		final Integer finalGeneration = 38;
...
//		String historyLogFolder = "ForExport/19_UtilityAndFreq/1_smallMetroRadiusLoweredCost/zurich_1pm/Evolution/Population/HistoryLog/"; GEN=1/38
		String historyLogFolder = "ForExport/19_UtilityAndFreq/1_smallMetroRadiusLoweredCost/zurich_1pm/Evolution/Population/HistoryLog/";
