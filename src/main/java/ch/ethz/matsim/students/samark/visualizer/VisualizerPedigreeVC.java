...
public class VisualizerPedigreeVC {
	...
	// %%% --- %% --- %% --- %% --- %% --- %% --- %% --- %% --- DISPLAY EVOLUTION OF NETWORKS---%%---%%---%%---%%---%%---%%---%%---%%---%%---%%%
		...
		bgImage = ImageIO.read(new FileInputStream(simName + "/zurich_1pm/bgImgVCfacilities2crop.png"));
		...
		final Double y0 = 20200.0; // top left corner of background image
		final Double x1 = 20200.0; // bottom right corner of background image
