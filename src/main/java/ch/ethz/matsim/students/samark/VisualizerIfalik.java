...
public class VisualizerIfalik {
	@SuppressWarnings("unchecked")
	public static void main(String[] args) throws IOException, XMLStreamException {
	// args[1, 2, 3] = firstGenerationPedigreeTree, finalGenerationPedigreeTree, networkName
...
// %%% --- %% --- %% --- %% --- %% --- %% --- %% --- %% --- DISPLAY EVOLUTION OF NETWORKS --- %% --- %% --- %% --- %% --- %% --- %% --- %% --- %% --- %% --- %%%
		...
		if (pedigreeTree.size() != finalGeneration-1) {
			Log.writeAndDisplay("CAUTION: Pedigree tree has not same number of generations as finalGeneration! Please check.");
		}
